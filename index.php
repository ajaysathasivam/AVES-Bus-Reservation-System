...
<title>Welcome to AVES Bus Reservation System</title>
<link rel="stylesheet" href="xres/css/style.css" />
...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="xres/images/logo1.png" class="logo" alt="AVES Bus Reservation System" /></a></h1>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/TN01.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/TN02.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/TN03.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/TN04.jpg" width="861" height="379"  alt="" /></li>
              </ul>
    ...
    <div id="featured">
        <div id="items">
            <div class="item"> <a href="main-course.php"><img src="xres/images/01.jpg" alt="" /></a>
            <h3><a href="main-course.php">Specials Offers</a></h3>
            <p><a href="#"><strong>KPN Bus</strong><br />
            ...
            <p><a href="lodging.php"><strong>From Chennai to Tirupathur</strong><br />
			Spend a relax evening in our Vellore Kitchen hotel. </a></p>  
			</div>
	...
	<div id="footer">
	<h4>+918999999999 &bull; <a href="contact-us.php">Gudiyatham, vellore, Tamil Nadu - 635653 </a></h4>
	<p>AVES of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
	<a href="index.php"><img src="xres/images/footer-logo.jpg" alt="James Buchanan Pub and Restaurant" /></a>
	<p>&copy; Copyright 2013 AVES Bus | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
